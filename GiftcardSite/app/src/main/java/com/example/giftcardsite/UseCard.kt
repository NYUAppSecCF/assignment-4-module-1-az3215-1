...
class UseCard : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val card: Card? = if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
        ...
        val loggedInUser: User? = if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
        ...
        val button: Button = findViewById(R.id.submit_buy)
